...
class Imagem {
    ...
    public function detectFallback(string $return = '') {
        ...
        //Valida��o dos Diret�rios e Arquivo Null
    ...
    public function saveImagem(string $localSource, string $imagemResized) {
        ...
        */
        ...
        //Toda Renderiza��o da Original acontece aqui
        $Canvas = new Canvas();
        $Canvas
            ->carrega($localSource)
            ->redimensiona($w, $h, $m)
    ...
    /*
    As condicionais para a renderiza��o de uma imagem ser�o centradas na URL, que naturalmente � a $this->getImagemOriginal():
    ...
    public function render() {
        ...
        //Garantir que exista uma c�pia local em caso de arquivos remotos
        if($this->isRemote()) {
            if(!file_exists($this->getCachedFilename('ori'))) {
                file_put_contents(
        ...
        //Se voc� j� possui um localSource e um resizedImage, ent�o resta exibir o que tem (em caso de cache ativo) ou reprocessar (em caso de cache inativo)
