...
/**
 * Inspired in: jajo/jsondb
 * 
 * use RBFrameworks\Core\Database\Json;
 * $json_db = new Json( __DIR__ ); // Or passing the directory of your json files with no trailing slash, default is the current directory. E.g.  new JSONDB( '/var/www/html/json_files' )
...
class Json {
	...
	public function __construct( $dir, $json_encode_opt = JSON_UNESCAPED_UNICODE|JSON_PRETTY_PRINT ) {
        Plugin::load("obj_to_array");
        Plugin::load("get_json_chunk");
		$this->dir = $dir;
