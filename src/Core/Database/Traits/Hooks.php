...
trait Hooks {
    public function pre_parse():callable {
        return function($hash) {
            \Core\Debug::log('pre_parse', $hash, 'MeekroDB.PreParse', 'MeekroDB');
        };
    }
    ...
    public function run_success():callable {
        return function($hash) {
            \Core\Debug::log('run_success', $hash, 'MeekroDB.RunSuccess', 'MeekroDB');
        };
    }
    public function run_failed():callable {
        return function($hash) {
            \Core\Debug::log('run_failed', $hash, 'MeekroDB.RunFailed', 'MeekroDB');
        };
    }
}