...
class EncodingJS
{
    ...
    public static function decodeURIComponent($string)
    {
        ...
        for ($i = 0; $i < strlen($string); $i++) {
            ...
            list($decodedstr, $num) = self::decodeURIComponentbycharacter($decstr);
    ...
    public static function encodeURI($string)
    {
        $result = "";
        for ($i = 0; $i < strlen($string); $i++) {
            $result .= self::encodeURIbycharacter(urlencode($string[$i]));
        }
        return $result;
    }
    ...
    public static function decodeURI($string)
    {
        ...
        for ($i = 0; $i < strlen($string); $i++) {
            ...
            list($decodedstr, $num) = self::decodeURIbycharacter($decstr);
            $result .= urldecode($decodedstr);
            $i += $num;
        }
        return $result;
    ...
    public static function unescape($string)
    {
        ...
        for ($i = 0; $i < strlen($string); $i++) {
            ...
            list($decodedstr, $num) = self::unescapebycharacter($decstr);
            $result .= urldecode($decodedstr);
            $i += $num;
        }
        return $result;
