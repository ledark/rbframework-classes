...
class Response
{
    public static function json(array $arr, bool $forceEncodeUTF8 = false, int $statusCode = 200):void {
    ...
    public static function js(string $text, int $statusCode = 200):void {
    ...
    public static function css(string $cssContent, int $statusCode = 200):void {
    ...
    private static function responseCode(int $statusCode):void {
